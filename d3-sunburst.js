if (screen.width < 768) {
    ...
    //initialize variables for tablets and larger
    var width = $("#myChart").width();
...
var color = d3.scaleOrdinal(d3.schemeCategory20b);
    ...
    d3.json("https://rawgit.com/emilywdeng/gastro-grocery-guide/master/data.json", function(error, nodeData) {
        ...
        d3.selectAll(".sizeSelect").on("click", function(d,i) {
            ...
            if (this.value === "size") {
              ...
              root.sum(function (d) { return d.filter; });
            }
            ...
            //change opacity of text for nodes that don't appear
            slice.selectAll("text")
                .style("opacity", function() {
                  var box = this.node().offsetWidth;
                  if(box = 0) {
